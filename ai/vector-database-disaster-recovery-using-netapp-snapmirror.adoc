...
. Escalabilidade: A solução de nuvem híbrida da NetApp oferece a capacidade de dimensionar seus recursos de acordo com suas necessidades. Você pode utilizar recursos locais para workloads regulares e previsíveis e recursos de nuvem, como o Amazon FSX ONTAP for NetApp ONTAP e o Google Cloud NetApp volume (GCNV) para períodos de pico ou cargas inesperadas.
