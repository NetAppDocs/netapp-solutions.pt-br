...
| switch1 portas 41-44 | AFF-A90-01 até -04 | porta e8a 
...
| switch2 portas 41-44 | AFF-A90-01 até -04 | porta e8b 
...
** Porta swp41 em cada switch para AFF-A90-01 (e8a e e8b), porta swp42 para AFF-A90-02, etc (bond17-20)
...
** porta de rede ifgrp add-port -node <node> -ifgrp <ifgrp> -ports <node>:e8a, <node>:e8b
...
+
*** svm modificar -vserver basepod-data -rdma ativado
