...
summary: Preparar a solução de dados para banco de dados vetorial para NetApp 
---
...
[role="lead"]
Esta seção fornece um script Python de exemplo usado para preparar dados para o banco de dados vetorial.
