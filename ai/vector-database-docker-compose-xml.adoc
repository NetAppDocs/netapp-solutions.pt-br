...
summary: docker-compose.xml - solução de banco de dados vetorial para NetApp 
---
...
[role="lead"]
Esta seção inclui um código YAML de amostra para a solução de banco de dados vetorial para NetApp.
