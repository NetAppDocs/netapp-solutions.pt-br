...
summary: values-xml - solução de banco de dados vetorial para NetApp 
---
= Apêndice A: Values.yaml
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Esta seção fornece código YAML de amostra para os valores usados na solução de banco de dados de vetor NetApp.
