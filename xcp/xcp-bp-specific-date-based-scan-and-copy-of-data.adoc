...
summary: Essa solução é baseada em um cliente que precisa copiar dados com base em uma data específica. 
---
= Digitalização específica baseada em data e cópia de dados
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Essa solução é baseada em um cliente que precisa copiar dados com base em uma data específica. Verifique os seguintes detalhes:
