...
Para obter uma lista completa das ferramentas do ONTAP para os recursos do VMware vSphere 10, https://www.netapp.com/support-and-training/documentation/ontap-tools-for-vmware-vsphere-documentation/["Ferramentas do ONTAP para recursos de documentação do VMware vSphere"] consulte .
