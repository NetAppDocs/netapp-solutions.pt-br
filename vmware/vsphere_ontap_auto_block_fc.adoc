...
. Verfiy que os drivers HBA estão instalados. Os HBAs suportados pela VMware têm drivers implantados fora da caixa e devem estar visíveis no link:++https://docs.vmware.com/en/VMware-vSphere/7.0/com.vmware.vsphere.storage.doc/GUID-ED20B7BE-0D1C-4BF7-85C9-631D45D96FEC.html++["Informações do adaptador de armazenamento"].
