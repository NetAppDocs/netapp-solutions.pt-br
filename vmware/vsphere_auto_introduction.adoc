...
* https://code.vmware.com/resources["Recursos do VMware"^]. Recursos necessários para projetar soluções para o data center definido por software, incluindo fóruns, padrões de design, código de exemplo e ferramentas de desenvolvedor.
