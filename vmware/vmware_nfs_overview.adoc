...
Consulte https://docs.vmware.com/en/VMware-vSphere/8.0/vsphere-storage/GUID-F602EB17-8D24-400A-9B05-196CEA66464F.html["Introdução ao armazenamento no ambiente vSphere"] para obter mais informações sobre os tipos de armazenamento suportados para o VMware vSphere Foundation.
...
Os recursos abrangentes do ONTAP Tools 10 podem ser https://www.netapp.com/support-and-training/documentation/ontap-tools-for-vmware-vsphere-documentation/["Ferramentas do ONTAP para recursos de documentação do VMware vSphere"]encontrados .
...
Para obter instruções passo a passo de implantação do plug-in SnapCenter, consulte a solução link:vmware_vcf_asa_scv_wkld.html["Use o plug-in do SnapCenter para VMware vSphere para proteger VMs em domínios de carga de trabalho VCF"].
...
Para obter mais informações, consulte https://docs.vmware.com/en/Site-Recovery-Manager/8.8/srm-installation-and-configuration/GUID-C1E9E7D0-B88F-4D2E-AA15-31897C01AB82.html["Visão geral do VMware Site Recovery Manager"].
...
** *Implante e use o plug-in SnapCenter para VMware vSphere para proteger e restaurar VMs*. Clique link:vmware_vcf_asa_scv_wkld.html["*aqui*"] em para obter as etapas de implantação.
