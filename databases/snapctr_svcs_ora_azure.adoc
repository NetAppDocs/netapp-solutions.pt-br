...
* Leia as instruções link:https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-protect-cloud-app-data-to-cloud.html#architecture["Proteja os dados das aplicações nativas da nuvem"^] gerais e as seções relacionadas ao Oracle e ao Azure NetApp Files.
