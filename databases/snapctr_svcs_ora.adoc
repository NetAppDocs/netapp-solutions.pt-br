...
* Leia as instruções gerais link:https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-protect-cloud-app-data-to-cloud.html#architecture["Proteja os dados das aplicações nativas da nuvem"^]e as seções relacionadas ao Oracle e ao Amazon FSX ONTAP.
