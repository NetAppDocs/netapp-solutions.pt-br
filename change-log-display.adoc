...
| 8 de junho de 2023 | Nuvem híbrida | Adicionado GCVE com CVS - recuperação de desastres consistente de aplicativos com NetApp SnapCenter e replicação Veeam 


| 8 de junho de 2023 | Nuvem híbrida | Adicionado GCVE com CVS - migração de VM para o armazenamento de dados NFS do NetApp Cloud volume Service no Google Cloud usando o recurso de replicação da Veeam 
...
| 7 de fevereiro de 2023 | Nuvem híbrida | Blog adicionado: Anunciando a disponibilidade geral do suporte ao armazenamento de dados do NetApp Cloud Volumes Service para o VMware Engine 
